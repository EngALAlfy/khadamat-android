...
class _AddNewItemState extends State<AddNewItem> {
  ...
  Widget build(context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(EzLocalization.of(context).get("add_item")),
        centerTitle: true,
      ),
      body: Form(
        key: _key,
...
/*
                ...
                TextButton.icon(
                  ...
                  label: Text(
                    EzLocalization.of(context).get("save"),
                    style: TextStyle(color: Colors.white),
                  ),
                ),
                SizedBox(
                ...
                TextButton.icon(
                  style: ButtonStyle(
                    backgroundColor:
                        MaterialStateProperty.all<Color>(Colors.amber[300]),
                  ),
                  onPressed: () {
                    if (_key.currentState.validate()) {
                      value2.sponsored = 1;
                  ...
                  label: Text(
                    EzLocalization.of(context).get("save_sponsored"),
                    style: TextStyle(color: Colors.white),
                  ),
                ),
                SizedBox(
                ...
                TextButton.icon(
                  ...
                  onPressed: () {
                    context.read<ItemsProvider>().clearAdd();
                    context.read<ItemsProvider>().notify();
                  },
                  icon: Icon(
                    Icons.clear,
                    color: Colors.white,
                  ...
                  label: Text(
                    EzLocalization.of(context).get("clear"),
                    style: TextStyle(color: Colors.white),
                  ),
                ),
                SizedBox(
